@extends('layouts.app', ['title' => 'Tambah Modul'])
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <div id="image-preview" class="image-preview">
                                                ...
                                                <input type="file" name="sampul" id="image-upload" required />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            ...
                                            <a href="{{ route('modul.index') }}" class="btn btn-warning">Kembali</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
