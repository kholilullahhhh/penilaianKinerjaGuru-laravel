...
class AgendaSeeder extends Seeder
{
    ...
    public function run(): void
    {
        Agenda::insert([
            ...
            [
                'user_id' => null,
                'judul' => 'Briefing Mingguan',
                'tempat_kegiatan' => 'Ruang Kepala Sekolah',
                'tgl_kegiatan' => '2025-08-15',
                'jam_mulai' => '07:30:00',
                'deskripsi_kegiatan' => 'Penyampaian agenda mingguan dan pengarahan.',
                'status' => 'publish',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'user_id' => null,
                'judul' => 'Rapat Evaluasi Kinerja Guru',
                'tempat_kegiatan' => 'Ruang Rapat 2',
                'tgl_kegiatan' => '2025-08-17',
                'jam_mulai' => '13:00:00',
                'deskripsi_kegiatan' => 'Evaluasi hasil mengajar dan pengembangan profesional.',
                'status' => 'publish',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'user_id' => null,
                'judul' => 'Diskusi Pengembangan Ekstrakurikuler',
                'tempat_kegiatan' => 'Ruang OSIS',
                'tgl_kegiatan' => '2025-08-18',
                'jam_mulai' => '10:00:00',
                'deskripsi_kegiatan' => 'Diskusi program ekstrakurikuler semester depan.',
                'status' => 'publish',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'user_id' => null,
                'judul' => 'Pelatihan Digitalisasi Pembelajaran',
                'tempat_kegiatan' => 'Lab Multimedia',
                'tgl_kegiatan' => '2025-08-20',
                'jam_mulai' => '08:00:00',
                'deskripsi_kegiatan' => 'Pelatihan penggunaan platform digital untuk pembelajaran.',
                'status' => 'publish',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'user_id' => null,
                'judul' => 'Rapat Internal Tim Kurikulum',
                'tempat_kegiatan' => 'Ruang Kurikulum',
                'tgl_kegiatan' => '2025-08-22',
                'jam_mulai' => '11:00:00',
                'deskripsi_kegiatan' => 'Diskusi revisi silabus dan RPP.',
                'status' => 'publish',
                'created_at' => now(),
                'updated_at' => now(),
            ],
